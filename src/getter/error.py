...
EDURA_PTIME_FAIL = DUTError(code=0x39, message="endurance test PASS TIMES less than 149")
EDURA_FTIME_FAIL = DUTError(code=0x39, message="Endurance test FAIL TIMES more than 1")
